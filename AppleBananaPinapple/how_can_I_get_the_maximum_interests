...
(() => {
	...
	console.log('you should put ' , init_saving, ' at first month', ' so in ', (total - init_saving) / 2, ' months you can get the_max_interest ', the_max_interest )
	console.log('in contrast if you put all the money into saving account, you will get', (total - init_saving) / 2 * 70 * 0.02 / 12)
})()
