...
train_file = open(os.path.join(absolute_path, 'assignment2train.csv'), 'r')
test_file = open(os.path.join(absolute_path,'assignment2test.csv'), 'r')

# train_file = open('/Users/Alexander/Documents/Tools/statistics/back propagation/example_1/assignment2train.csv', 'r')
# test_file = open('/Users/Alexander/Documents/Tools/statistics/back propagation/example_1/assignment2test.csv', 'r')
