...
def final(final, desire, true, sum_error, output_file, d_final):
    ...
    print("\nClassified as Quality 5:", output_file)
    ...
    print("\nClassified as Quality 7:", output_file)
    if not c2:
    ...
    print("\nClassified as Quality 8:", output_file)
    if not c3:
    ...
    print('Training Sum error is {}\n'.format(sum_error), output_file)
    print('Training Mean squared error is {}\n'.format((1 / len(d_final)) * sum_error), output_file)
    ...
    if not c1:  # execute when c1 is empty
        ...
        print('Class one Quality 5:\nPrecision:{}\nRecall:{}\n'.format(pre1, re1), output_file)
    if not c2:
        print('None of them have been classified to Quality 7\n')
        print('None of them have been classified to Quality 7\n', output_file)
    else:
        print('Class two Quality 7:\nPrecision:{}\nRecall:{}\n'.format(pre2, re2))
        print('Class two Quality 7:\nPrecision:{}\nRecall:{}\n'.format(pre2, re2), output_file)
    if not c3:
        print('None of them have been classified to Quality 8\n')
        print('None of them have been classified to Quality 8\n', output_file)
    else:
        print('Class three Quality 8:\nPrecision:{}\nRecall:{}\n'.format(pre3, re3))
        print('Class three Quality 8:\nPrecision:{}\nRecall:{}\n'.format(pre3, re3), output_file)
    print('The Classification Accuracy is {}%\n'.format(accuracy))
    print('The Classification Accuracy is {}%\n'.format(accuracy), output_file)
...
Predicted Class |   Quality "7"       {}      |        {}        |      {}
    ...
    Predicted Class |   Quality "7"       {}      |        {}        |      {}
        ...
        '''.format(p11, p12, p13, p21, p22, p23, p31, p32, p33), output_file)
